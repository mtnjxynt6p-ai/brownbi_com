      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 mb-4 mt-2 text-center">
            <h2>In-Home Imagery Solutions</h2>
          </div>
        </div>
      </div>
      <div class="container ">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 text-center">
            <img class="rounded-circle" alt="140x140" style="width: 140px; height: 140px;" src="images/iconCloudUpload.svg" title="Created by Iconic from Noun Project" data-holder-rendered="true">
            <h3>Persona  Cloud</h3>
            <p>&nbsp;</p>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-12 text-center">
